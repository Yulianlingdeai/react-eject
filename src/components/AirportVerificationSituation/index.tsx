...
export default function AirportVerificationSituation() {
    ...
    const btnList = [
        { id: 1, label: "2m气温", src: icon_2mtem, style: { width: "22px", height: "32px" } },
        {
            id: 2,
            label: "10m风向",
            src: icon_10m_wind_direction,
            style: { width: "28px", height: "28px" }
        },
        {
            id: 3,
            label: "10m风速",
            src: icon_10m_wend_speed,
        ...
        },
        {
            ...
            label: "能见度",
            src: icon_visibility,
            style: { width: "26.6px", height: "22px" }
        },
        {
            id: 8,
            label: "低云云量",
            src: icon_low_cloud_cover,
            style: { width: "28.6px", height: "22px" }
        },
        {
            id: 9,
            label: "低云云底高",
            src: icon_low_clouds_high,
            style: { width: "26px", height: "26px" }
        }
    ];
    return (
